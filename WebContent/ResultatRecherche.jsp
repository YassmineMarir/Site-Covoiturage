...
<%
	...
	ArrayList<Trajet> a = (ArrayList<Trajet>) request.getAttribute("resultSearch");
		...
		%>
			<div class="col-sm-4" style="margin: 0px 0px 50px 0px">
				...
				<form action="Reserver" method="post" >
					...
					<center>
				<button  style="background: #f05f40;color:#fff; border-radius:5px" class="btn" name="reserver" value="<%=a.get(i).getId_trajet() %>">
				Réserver Trajet
				</button>
					</center>
				</form>
