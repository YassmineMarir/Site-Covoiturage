			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<div class="w3_navigation_pos">
						<h1><a href="index.html"><span>C</span>ovoi <span>T</span>urage</a></h1>
					</div>
				</div>
...
<!-- about-top -->
	<div class="agile-about-top">
		<div class="container">
		<h2 class="tittle-w3">AI<span>DE</span></h2>
			<div class="about-section">
				<div class="col-md-7 ab-left">
				  <div class="grid">
			        <div class="h-f">
					<figure class="effect-jazz">
					<img src="images/p1.jpg" alt="img25">
						<figcaption>
							<h4>HAYYA <span>Simple et économique</span></h4>
				 ...
				 <div class="h-f">
					<figure class="effect-jazz">
						<img src="images/p2.jpg" alt="img25">
						<figcaption>
							<h4>HAYYA <span>réservez facilement</span></h4>
				 ...
				 <div class="h-f">
					<figure class="effect-jazz">
						<img src="images/p3.jpg" alt="img25">
						<figcaption>
							<h4>HAYYA <span>Économique et convivial</span></h4>
				 ...
				 <div class="h-f">
					<figure class="effect-jazz">
						<img src="images/p4.jpg" alt="img25">
						<figcaption>
							<h4>HAYYA <span>voyagez moins cher</span></h4>
			   ...
			   <div class="col-md-5 ab-text">
			        <h3 class="tittle-w3"><span>HAYYA Allez où vous voulez</span> D'où vous voulez</h3>
					<p>Le covoitureur (conducteur) rend un service à la collectivité d’une part grâce à l’impact évité d’un 
ou plusieurs déplacements d’autosolistes et d’autre part du fait que dans bien des cas il introduit une offre de 
transport dans des secteurs peu denses où l’offre de transport en commun est soit inexistante soit extrêmement limitée. 
					<span></span></p>
				</div>
				<div class="clearfix"> </div>
			 </div>
	...
	<!--count-->
			<div class="count-agileits">
				<div id="particles-js"></div>
					...
					<h3 class="tittle-w3">SIMPLIFIER <span>ENCOURAGER</span> LA PRATIQUE DU COVOITURAGE</h3>
	...
	<div class="team">
		<div class="container">
			<h3 class="tittle-w3"><span>NOS </span>Conducteur</h3>
			<div class="team-row">
				<div class="col-md-3 team-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h5>Moha<span>Med</span></h5>
					<p>De Batna 60ans Clio4</p>
					
					<div class="team-img">
						<img src="images/FFFFF.jpg" alt="">
					</div>
				</div>
				<div class="col-md-3 team-grids team-mdl wow fadeInUp animated" data-wow-delay=".5s">
					<h5>Ami<span>Ra</span></h5>
					<p>De Constantine 26ans Ibiza</p>
				...
				<div class="col-md-3 team-grids team-mdl1 wow fadeInUp animated" data-wow-delay=".5s">
					<h5>Ouss<span>Ama</span></h5>
					<p>De Constantine 25ans Lion</p>
					
					<div class="team-img">
						<img src="images/fghjklmm.jpg" alt="">
					</div>
				</div>
				<div class="col-md-3 team-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h5>Meh <span>Di</span></h5>
					<p>De Blida 29ans Cirato </p>
...
<!-- Footer -->
			...
			<div class="copyright-wthree">
				<p>&copy; 2018 HAYYA CovoiTurage . Constantine2</a></p>
			</div>
<!-- //Footer -->
