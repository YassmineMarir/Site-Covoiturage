...
<html lang="en">
  <head>
    ...
    <title>Formulaire Profil conducteur | </title>
          ...
          <div class="">
            <div class="page-title">
			  ...
			  <div class="title_left">
				        ...
				        <a href="rechercher_trajet_log.html"><i class="fa fa-search"></i> Rechercher trajet</button></a>
						
						<button type="button" class="btn btn-success btn-lg">
				        <i class="fa fa-plus-circle"></i> Proposer trajet</button>
						<br>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-6 col-sm-6 col-xs-12" style="height: 900px ; width: 780px">
					<div class="x_panel" >
					  <div class="x_title">
						<h2><i class="fa fa-bars"></i> Modifier profil </h2> <br> <br>
						
							
							
							  <form action="ModificationCompte" method="post" class="form-horizontal form-label-left input_mask">
                                   <div class="form-group">
								   <label class="col-md-6 col-sm-6 col-xs-12">Nom <span class="required">*</span>
									</label>
								  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<input name="nom" type="text"  class="form-control has-feedback-left" id="inputSuccess2"   placeholder="Mehamdi">
									<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
								  </div>
								  </div>
                                   <div class="form-group">
								   <label class="col-md-6 col-sm-6 col-xs-12">Prénom <span class="required">*</span>
									</label>
								  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<input name="prenom" type="text" class="form-control has-feedback-left" id="inputSuccess3"  placeholder="Ahmed">
									<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
								  </div>
								  </div>
								  <div class="form-group">
								  <label class="col-md-6 col-sm-6 col-xs-12">Date de naissance <span class="required">*</span>
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
									  <input name="date_nais" type="date" class="form-control" rows="3" placeholder="11/12/1987"></input>
									</div>
								  </div>
                                   <div class="form-group">
								   <label class="col-md-6 col-sm-6 col-xs-12">email<span class="required">*</span>
									</label>
								  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<input name="email" type="email" class="form-control has-feedback-left" id="inputSuccess4"  placeholder="mehamdi.ahmed@gmail.com">
									<span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>
								  </div>
								  </div>
                                   <div class="form-group">
								   <label class="col-md-6 col-sm-6 col-xs-12">type<span class="required">*</span>
									</label>
								  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
									<input name="utilisateur" type="text" class="form-control has-feedback-left" id="inputSuccess4"  placeholder="conducteur">
									<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
								  </div>
								  </div>
								  ...
								  <div class="form-group">
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
									  <input name="password" type="password" class="form-control" readonly="readonly" value="passwordonetwo">
									</div>
									<br>
									<br>
									...
									<div class="buttons">
										<br>
										<br>
										<button type="button" class="btn btn-success btn-lg" style="background:green"">
									
										
										<i class="fa fa-check-square"></i> Enregistrer modifications</button>
										<br>
										<br>
								...
								<div class="row">
								  ...
								  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
									<input type="text"   placeholder="Chevrolet" class="form-control">
								  </div>

								  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
									<input type="text"   placeholder="Sail" class="form-control">
								  </div>
								  
								  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
									<input type="text"   placeholder="2009AS05244" class="form-control">
								  </div>

								  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
									<input type="text"   placeholder="2324-109-25" class="form-control">
								  </div>

								  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
									<input type="text"   placeholder="2009" class="form-control">
