...
<%
  ...
  ArrayList<Reservation> a=new Reservation().getReservation();
	System.out.print("asds"+a.size());
	for(int i=0; i<a.size();i++){
		%>
			<div class="col-sm-4" style="margin: 0px 0px 50px 0px">
				...
				<h1 class="card-title" style="color:#fff" >Réservation
				</h1>
			</div>
					<div class="card-body">
						
						<p class="card-text"> nombre de places réservées <%=a.get(i).getPlace()%> .
						</p>
						
					
				
						
						<p class="card-text"> Numéro du trajet <%=a.get(i).getId_trajet()%> .
						</p>
