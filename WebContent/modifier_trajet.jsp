...
<li class="nav-item dropdown"><a
					...
					<ul class="dropdown-menu">
						...
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
							href="supprimer_trajet.jsp">SUPPRIMER TRAJET</a></li>
						<li class="nav-item"><a class="nav-link js-scroll-trigger"
	...
	for(int i=0; i<a.size();i++){
		%>		
			<div class="col-sm-4" style="margin: 0px 0px 50px 0px">
				...
				<form action="selectionnerIdTrajet" method="post">
					<div class="card-footer">
						<small class="text-muted">Date départ <%=a.get(i).getDate_départ()%></small>
					</div>
					<center>
				<button  style="background: #f05f40;color:#fff; border-radius:5px" class="btn" name="mod" value="<%=a.get(i).getId_trajet() %>">
				<a href="ModificationTrajet.jsp">modifier </a></button>
					</center>
				</form>
				</div>
			</div>
