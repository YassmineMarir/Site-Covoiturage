...
<!-- //for-mobile-apps -->
<link href="home-assets/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="home-assets/css/font-awesome.css" rel="stylesheet"> 
<link href="home-assets/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!--web-fonts-->
		...
		<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li class="menu__item menu__item--current"><a href="AcceuilConducteur.jsp" style="height: 50px; width: 100px ; background: #fd6239"><h2><span class="label label-warning" ><i class="fa fa-plus-circle" style="color: white"></i>Proposer Trajet </span></h2></a></li>

					<li class="menu__item"><a href="Aide.jsp" class=" menu__link">Aide</a></li>
					<li class="dropdown menu__item menu__item--current"><a href="#" class="dropdown-toggle menu__link"  data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Profil <span class="caret"></span></a>
						<ul class="dropdown-menu">
						 
							<li><a href="profil_conducteur1.jsp"  style="color:black"> Voir profil</a></li>
							<li><a href="ListeReservation.jsp" style="color:black">Réservations</a></li>
							...
							<button style="color:black" name="Deconnecte" value="Deconnexion">Deconnexion</button>
							</form>
							</li>
			   ...
			   <form action="ResultatRecherche" method="post">
					<div class="col-md-3 form-time-w3layouts">
							<label><i class="fa  fa-map-marker" aria-hidden="true"></i> De :</label>
							 <input name="lieu_départ" class="select2_single form-control" tabindex="-1">
                            
							
					</div>
					<div class="col-md-3 form-left-agileits-w3layouts ">
							<label><i class="fa  fa-map-marker" aria-hidden="true"></i> A :</label>
							<input name="lieu_arrivée" class="select2_single form-control" tabindex="-1">
 ...
 <div class="ab-w3l-about">
	<div class="container">
		 <h3 class="tittle-w3"><span>bienvenu dans notre</span> site</h3>
			<p class="para-w3l">Notre site fournir une offre en quasi temps réel à  l'usager covoitureur . La 
personne  souhaitant  effectuer  un  itinéraire  en  covoiturage  contacte  le  service  avant  son 
départ. Le service va alors chercher le conducteur adéquat qui est en mesure d'offrir le covoiturage souhaité 
sur l'itinéraire demandé.Avec  une  quantité  suffisante  de  participants,  le  fonctionnement  est  souple  et  permet  une  bonne  qualité  de 
service 
	...
	<div class="about" id="about">
      <div class="col-md-6 ab-w3-agile-info">
	   <div class="ab-w3-agile-info-text">
		 ...
		 <p class="para-w3l">HAYYA rassemble une communauté de covoiturage longue distance en Algérie. Nous mettons en relation des conducteurs voyageant avec des places libres et des passagers souhaitant faire le meme trajet.Les couts des trajets sont partagés entre les covoitureurs. </p>
		  ...
		  <div class="ab-w3-agile-inner">
	       <div class="col-md-6 ab-w3-agile-part">
		     ...
		     <p class="para-w3l">Vous êtes passeger ? 
		     Réservez une place , simple et économique.
		     Réservez facilement votre place en ligne et voyagez moins cher , en toute confiance.Vite inscrivez vous avec HAYYA,  y a plus de temps à perdre et y a pas mieux</p>
	       </div>
			<div class="col-md-6 ab-w3-agile-part two">
			<h4>Vous être conducteur ?</h4>
		     <p class="para-w3l"> Proposez vos trajets et le nombre de places,
		     partagez vos frais,et économisez le prix du carburant en collaborant avec des voyageurs sympas lors de vos longs trajets.Vite inscrivez vous avec HAYYA,plus de temps à perdre</p>
	       </div>
			<div class="clearfix"></div>		   
	  </div>	
   </div>	 	  
					...
					<div class="count-bgcolor-w3ls">
						...
						<i class="fa fa-car" aria-hidden="true"></i>
							<div class="count hvr-bounce-to-bottom">
								<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1052' data-delay='.5' data-increment="100">${nbrConduct}</div>
									<span></span>
									<h5>Conducteurs</h5>
							</div>
						</div>
						...
						<i class="fa fa-users" aria-hidden="true"></i>
							<div class="count hvr-bounce-to-bottom">
								<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='372' data-delay='.5' data-increment="100">${nbrVoy}</div>
									<span></span>
									<h5>Voyages</h5>
							</div>
						</div>
						...
						<i class="fa fa-user-plus" aria-hidden="true"></i>
							<div class="count hvr-bounce-to-bottom">
								<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='105209' data-delay='.5' data-increment="100">${nbrReservation}</div>
									<span></span>
									<h5>Membres</h5>
								</div>
						</div>
...
<!-- mail -->
						...
						<h3 class="tittle-w3">Contact <span>Info</span></h3>
							<div class="col-md-4 mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Phone</p><span>(+213) 06-65-70-55-72</span>
								</div>
							</div>
							<div class="col-md-4 mail-agileits-w3layouts">
								<i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Email</p><a href="mailto:info@example.com">cov.voiturage@gmail.com</a>
								</div>
							</div>
							<div class="col-md-4 mail-agileits-w3layouts">
								<i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>
								<div class="contact-right">
									<p>Addresse</p><span>Ali Mendjli, Constantine, Algérie.</span>
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
				...
				<div class="col-md-7 map ">
					...
					<div class="col-md-5 mail-grid1-form ">
						<h3 class="tittle-w3"><span>Envoyer un </span>Message</h3>
						<form action="#" method="post">
							<input type="text" name="Name" placeholder="Nom" required="" />
							<input type="email" name="Email" placeholder="Email" required="" />
							<textarea name="Message" placeholder="Taper votre texte ici...." required=""></textarea>
