...
<%
		...
		if (session.getAttribute("email") != null) {
			...
			if(session.getAttribute("type")!= "Voyageur"){
		...
		<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li class="menu__item menu__item--current"><a href="proposer_trajetNoLog.jsp" style="height: 50px; width: 100px ; background: #fd6239"><h2><span class="label label-warning" ><i class="fa fa-plus-circle" style="color: white"></i>Proposer Trajet </span></h2></a></li>

					<li class="menu__item"><a href="Aide.jsp" class=" menu__link">Aide</a></li>
					<li class="menu__item"><a href="inscription.jsp" class=" menu__link">Inscription</a></li>
				    <li class="menu__item"><a href="login.jsp" class=" menu__link">Connexion</a></li>
		  ...
		  <div class="ab-w3-agile-inner">
	       <div class="col-md-6 ab-w3-agile-part">
			...
			<h4>Vous être conducteur ?</h4>
		     ...
		     partagez vos frais,,et économisez le prix du carburant en collaborant avec des voyageurs sympas lors de vos longs trajets.
		     Vite inscrivez vous avec HAYYA,plus de temps à perdre</p>
	       </div>
			<div class="clearfix"></div>		   
	  </div>	
   </div>	 	  
					...
					<div class="container">	
						<h3 class="tittle-w3">Contact <span>Info</span></h3>
							...
							<div class="col-md-4 mail-agileits-w3layouts">
								...
								<div class="contact-right">
									<p>Email</p><a href="mailto:info@example.com">HAYYA.covoiturage@gmail.com</a>
								</div>
							</div>
							<div class="col-md-4 mail-agileits-w3layouts">
