<%@page import="Servlets.ModificationTrajet"%>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a  href="ToutLesTrajets1.jsp"><i class="fa fa-road"></i> Mes Trajets <span class="fa fa-chevron-right"></span></a>
          ...
          <div class="">
            <div class="page-title">
			  ...
			  <div class="title_left">
						...
						<button type="button" class="btn btn-success btn-lg">
				        <i class="fa fa-plus-circle"></i>Trajets Proposés</button>
						<br>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-6 col-sm-6 col-xs-12" style="height: 900px ; width: 780px">
					<div class="x_panel" >
					  <div class="x_title">
						<h2><i class="fa fa-bars"></i> Modifier Trajet </h2> <br> <br>
						
							
							
				<form action="ModificationTrajet" method="post" class="form-horizontal form-label-left input_mask">
                                <%
				int idTrajet = Integer.parseInt(request.getParameter("mod"));
			Trajet t = new Trajet();
			ArrayList<Trajet> a = t.SelectionIDTrajet(idTrajet);
	...
	%>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="lieu_départ" class="select2_single form-control" tabindex="-1">
								...
								<option value="<%=a.get(i).getLieu_départ() %>"><%=a.get(i).getLieu_départ() %></option>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="lieu_arrivée" class="select2_single form-control" tabindex="-1">
                           ...
                           <option value="<%=a.get(i).getLieu_arrivée() %>"><%=a.get(i).getLieu_arrivée() %></option>
                          </select>
                        </div>
                      </div>
					  <br>
								  ...
								  <label class="control-label col-md-3 col-sm-3 col-xs-12">Date Départ : <span class="required">*</span>
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
									  <input name="date_départ" type="date" class="form-control" rows="3" placeholder="<%=a.get(i).getDate_départ()%>"></input>
									</div>
								  </div>
								  <br>
								 <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="heure_départ" type="text" id="" value="<%=a.get(i).getHeure_départ()%>" placeholder="<%=a.get(i).getHeure_départ()%>"required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <br>
				<br>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="prix"type="text" id="first-name" value="<%=a.get(i).getPrix()%>" placeholder="<%=a.get(i).getPrix()%>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
				...
				<br>
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="place" class="select2_single form-control" tabindex="-1">
                            ...
                            <option value="<%=a.get(i).getPlace()%>"><%=a.get(i).getPlace()%></option>
								...
								<br>	
									<div class="buttons">
				                        ...
				                        <i class="fa fa-plus-circle"></i> Enregistrer Modifications </button>
										<br>
										<br>
